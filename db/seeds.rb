...
e1 = Event.create( name: "Pacific Beach Half Marathon", date: DateTime.new(2022, 10, 1), fee: 115, category: "half marathon", img:"https://i.ibb.co/xJKQg2X/pacific.png")
e2 = Event.create( name: "San Diego Santa Run", date: DateTime.new(2022, 12, 10), fee: 50, category: "5K", img:"https://i.ibb.co/RPTyRkF/santa.png" )
